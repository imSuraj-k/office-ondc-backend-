export const templateKeys = {
    ...
    fnb: [
        'nutritionalInfo', 'additiveInfo', 'isVegetarian'
    ],
    fashion: [
    ...
    electronics: [
        'length', 'breadth', 'height', 'weight', 'isReturnable'
    ]
}

export const commonKeys = [
    'productCode', 'productName', 'MRP', 'retailPrice', 'purchasePrice',
    'HSNCode', 'GST_percentage', 'productCategory', 'quantity', 'barcode',
    'maxAllowedQty', 'UOM', 'packQty', 'returnWindow', 'manufactureName',
    'manufactureDate', 'instructions', 'isCancellable', 'longDescription',
    'availableOnCod', 'description', 'images'
