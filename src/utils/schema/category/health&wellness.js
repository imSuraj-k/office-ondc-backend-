import { FIELD_ALLOWED_BASED_ON_PROTOCOL_KEY } from '../../constants.js'
const BPP_ID = "stage.ramonize.com"
const BPP_URI = "https://stage.ramonize.com/ondc"

export async function mapHealthnWellnessData(data) {
...
export async function mapHealthnWellnessDataUpdate(data){
    let itemObjData = {}; 
    for (const org of data?.data?.products) {
        let productAvailable = []
        for (let items of org.items) {
