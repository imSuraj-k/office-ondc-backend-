...
const { domainNameSpace } = require("../constants.js");
import { mapGroceryData, mapGroceryDataUpdate } from './category/grocery.js';
import { mapFashionData, mapFashionDataUpdate } from './category/fashion.js'
import { mapFnBData, mapFnBDataUpdate } from './category/fnb.js';
import { mapElectronicsData, mapElectronicsDataUpdate } from './category/electronics.js';
import { mapHealthnWellnessData, mapHealthnWellnessDataUpdate } from './category/health&wellness.js';
import { mapHomenDecorData, mapHomenDecorDataUpdate } from './category/home&decor.js';
import { mapAppliancesData, mapAppliancesDataUpdate } from './category/appliances.js';
import { mapBPCData, mapBPCDataUpdate } from './category/bpc.js';
import { mapAgricultureData, mapAgricultureDataUpdate } from './category/agriculture.js';
import { mapToysnGamesData, mapToysnGamesDataUpdate } from './category/toys&games.js';
const BPP_ID = "stage.ramonize.com"
const BPP_URI = "https://stage.ramonize.com/ondc"
...
export const getProductUpdate = async (data) => {
...
export const getUpdateItem = async (data) => {
