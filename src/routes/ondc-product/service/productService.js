...
class ProductService {
    async create(data, currentSeller) {
        console.log('DATA at line no. 13 in productService.js : ', data);
        try {
            const { orgId, staffID, providerId } = currentSeller;
            console.log('product name at line no 16', data.commonDetails.productName)
           const pid = providerId
           const oid = orgId
            console.log("pid",  pid, "oid", oid)
